...
public class MixtureBetDialog extends DialogFragment {
    Unbinder unbinder;
    ...
    public MixtureBetDialog() {

    }

    public static MixtureBetDialog newInstance(ScoreList.DataBean.MatchBean mPopupBean, int index, String foot) {
        MixtureBetDialog instance = new MixtureBetDialog();
