...
public class JooyerBubbleRecyclerView extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray array = context.obtainStyledAttributes(attrs,R.styleable.JooyerBubbleRecyclerView);
        ...
        int location = array.getInt(R.styleable.JooyerBubbleRecyclerView_jooyer_bubble_arrow_direction, 1);
