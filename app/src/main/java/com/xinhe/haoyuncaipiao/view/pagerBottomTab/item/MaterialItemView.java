package com.xinhe.haoyuncaipiao.view.pagerBottomTab.item;
...
import com.xinhe.haoyuncaipiao.view.pagerBottomTab.internal.RoundMessageView;
...
public class MaterialItemView extends BaseTabItem {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mHideTitle){
            mLabel.setVisibility(mChecked ? VISIBLE : INVISIBLE);
        }
