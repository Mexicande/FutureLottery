...
public class SuperLottoCommonFragment extends BaseFragment {
    ...
    private void getRandomCount(int count) {
        ...
        for (int j = 0; j < count; j++) {
            ArrayList<String> chooseRedBalls = RandomMadeBall.getManyBall(35, 5);
            ArrayList<String> chooseblueBalls = RandomMadeBall.getManyBall(12,2);
    ...
    private void calculatorResult() {
        zhushu = Calculator.calculateSLNum(selectRedNumber, selectBlueNumber);
    ...
    private void initView() {
        ...
        redBallAdapter = new DoubleBallRedAdapter(getContext(), chooseRedBall, isShow, 35);
        blueBallAdapter = new DoubleBallBlueAdapter(getContext(), chooseblueBall, isShow, 12);
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.bottom_result_next_btn:
                ...
                //判断单复式
                if (chooseRedBall.size() > 5 || chooseblueBall.size() > 2) {
                    sl.setType(1);
                } else {
                    sl.setType(0);
                }
    ...
    private void getBallNumber() {
        chooseRedBall.clear();
        chooseRedBall.addAll(RandomMadeBall.getManyBall(35, 5));
        chooseblueBall.clear();
        chooseblueBall.addAll(RandomMadeBall.getManyBall(12,2));
    }
